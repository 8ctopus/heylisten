...
return [
    ...
    */
    ...
    'alpha_dash'      => ":attributeには、文字と数字('A-Z','a-z','0-9')とハイフンと下線('-','_')が使用できます。",
    'alpha_num'       => ":attributeには、文字と数字('A-Z','a-z','0-9')が使用できます。",
    ...
    */
    ...
    'custom' => [
        ...
        'rich-text' => ':attributeに無効なHTMLタグがあります。',
        'alpha_dash_english' => ':attributeは、半角英数字のみで入力してください。',
    ],
